...
-- Write a query that returns one city that has the highest sum of invoice totals. Return both 
...
-- Return your list ordered alphabetiaclly by email starting with A
...
-- where the top amount is shared, provide all customers who spent this amount
...
select cc.billing_country, cc.total_spending,ms.max_spending, cc.first_name, cc.last_name
